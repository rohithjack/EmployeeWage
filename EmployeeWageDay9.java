...
public class EmployeeWageDay9{
	...
	public static void main(String args[])
	{
		...
		company1.wage ("Company1",20,8,20);
		company2.wage ("Company2",25,8,20);
		company3.wage ("Company3",30,8,22);
...
class EmpWageCalculator {
	...
	public void wage(String company ,int wagePerHour ,int noofWorkingHoursPerDay ,int workingDaysinMonth )
...
//					int workingDaysinMonth = input.nextInt ( );
			...
			System.out.println ( company +"Employee Absent " );
